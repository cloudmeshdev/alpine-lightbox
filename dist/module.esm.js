...
function src_default(Alpine) {
  document.addEventListener("alpine:init", () => {
    ...
    body.insertAdjacentHTML("afterbegin", `<div style="display: none;" x-bind:class="$store.lightbox.show ? '' : 'hidden'" class="fixed z-50 inset-0 overflow-y-auto alpine-lightbox" aria-labelledby="modal-title" role="dialog" aria-modal="true" x-show="$store.lightbox.show" x-data>
